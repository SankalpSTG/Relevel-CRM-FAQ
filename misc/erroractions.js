...
errorActions.invalidAuth = [400, {error: true, error_message: "Invalid Email ID or Password", action_code: 0}]
errorActions.invalidEmailID = [400, {error: true, error_message: "Invalid Email ID", action_code: 0}]
errorActions.invalidPassword = [400, {error: true, error_message: "Invalid Password", action_code: 0}]
...
errorActions.failedToUpdatePassword = [400, {error: true, error_message: "Failed To Update Password", action_code: 0}]

errorActions.pleaseEnter = function(key){
    return [400, {error: true, error_message: "Please Enter " + key, action_code: 0}]
}
errorActions.errorMessage = function(key){
    return [400, {error: true, error_message: key, action_code: 0}]
}
errorActions.successMessage = function(key){
    return [200, {error: false, error_message: key, action_code: 0}]
}
